...
for(let i=0; i<365; i++){
    ...
    elem.classList = list.includes(i) ? "box active" : "box";
    iconContainer.appendChild(elem);
}
...
window.addEventListener("scroll", ()=>{
    ...
    console.log(offsetY);
    saluteTextContainer.style.transform = `translate(-${offsetY*0.1}px, -${offsetY*0.7}px)`;
    saluteImageContainer.style.transform = `translate(${offsetY*0.4}px, ${offsetY*0.9}px)`;
    nameContainer.style.transform = `translateX(calc(50vw - ${offsetY}px))`;
    titleContainer[0].style.backgroundPositionY = `-${offsetY*0.7}px`;
    titleContainer[1].style.backgroundPositionY = `${offsetY*0.7}px`;
    title[0].style.transform = `translateX(calc(-200vh + (${offsetY}px))`;
    title[1].style.transform = `translateX(calc(300vh - (${offsetY}px))`;
    projectTitle.style.transform = `translateY(calc(400vh - ${offsetY}px))`;
    projectImageContainer[0].style.transform = `translateX(calc(450vh - (${offsetY}px))`;
    projectDetail[0].style.transform = `translateX(calc(-450vh + (${offsetY}px))`;
    projectImageContainer[1].style.transform = `translateX(calc(-560vh + (${offsetY}px))`;
    projectDetail[1].style.transform = `translateX(calc(560vh - (${offsetY}px))`;
    projectImageContainer[2].style.transform = `translateX(calc(590vh - (${offsetY}px))`;
    projectDetail[2].style.transform = `translateX(calc(-590vh + (${offsetY}px))`;
})